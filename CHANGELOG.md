...
- Hand-typed TypeScript wrapper, declarations emitted via `tsc`.
- Vitest in two modes: Node and Playwright/Chromium.
- Browser (Vite) and Node CLI example apps.

## Unreleased

### Added

- Add byte array example
